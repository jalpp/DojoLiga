        ...
        ManageRoles manageRoles = new ManageRoles();
            ...
            if (passport.userPresent(collection, event.getUser().getId(), name)) {
                ...
                if(event.getGuild().getId().equalsIgnoreCase(Keys.MAIN_GUILD)){
                    ...
                    if(passport.userPresentNormal(MongoConnect.getRRplayercollection(), event.getUser().getId()) && passport.getReletatedLichessName(event.getUser().getId(), MongoConnect.getRRplayercollection()).equalsIgnoreCase("null")){
                        passport.updatePlayerForPlatformName(MongoConnect.getRRplayercollection(), passport.getPlayerDoc(MongoConnect.getRRplayercollection(), event.getUser().getId()), Platform.LICHESS, name);
                    }
        ...
        ManageRoles manageRoles = new ManageRoles();
            ...
            if (passport.userPresentChesscom(collection, event.getUser().getId(), name)) {
                ...
                if(event.getGuild().getId().equalsIgnoreCase(Keys.MAIN_GUILD)){
                    ...
                    if(passport.userPresentNormal(MongoConnect.getRRplayercollection(), event.getUser().getId()) && passport.getReletatedChessName(event.getUser().getId(), MongoConnect.getRRplayercollection()).equalsIgnoreCase("null")){
                        passport.updatePlayerForPlatformName(MongoConnect.getRRplayercollection(), passport.getPlayerDoc(MongoConnect.getRRplayercollection(), event.getUser().getId()), Platform.CHESSCOM, name);
                    }
