...
public enum CohortRange {
    ...
    /**
     * Get cohort from role name cohort range.
     *
     * @param name the name
     * @return the cohort range
     */
    public static CohortRange getCohortFromRoleName(String name){
        for(CohortRange cohort: CohortRange.values()){
            if(cohort.getDiscordCohortName().equalsIgnoreCase(name)){
                return cohort;
            }
        }
        return null;
    ...
    /**
     * Get discord role cohort cohort range.
     *
     * @param member the member
     * @return the cohort range
     */
    public static CohortRange getDiscordRoleCohort(Member member){
       List<Role> roles = member.getRoles();

       for(Role role: roles){
           CohortRange cohort = getCohortFromRoleName(role.getName());
           if(cohort != null){
               return cohort;
           }
       }
